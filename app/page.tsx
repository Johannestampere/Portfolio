    ...
    <div className='flex w-full min-h-screen flex-col items-center px-8'>
      ...
      >
        ...
        <section className='flex flex-col gap-6 pt-16'>
          ...
          <div className={`${latonormal.className}`}>I love attending hackathons, working on meaningful projects with awesome people, and connecting with people who share my interests. I&#39;m also into sports and always up for a good conversation, so feel free to reach out!</div>s
        </section>
